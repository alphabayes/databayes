...
from ohlcv_indicators import OHLCVIndicatorBase
    ...
    def prepare_data_ml(self, logging=logging):
        ...
        if os.path.exists(self.data_ml_filename) and \
           not(self.rebuild_ml_data):
            logging.info(f"Load ML data from filename {self.data_ml_filename}")
